...
export default {
    ...
    async mounted() {
        await this.getWithdrawDay();
    },

    methods: {
        async getWithdrawDay() {
            this.$store.commit('setLoading', true);
            await this.withdrawDay.GetWithdrawDay().then(result => {
        ...
        async confirmOrder(item) {
            ...
            await this.withdrawDay.ConfirmOrderDay(id).then(async (result) => {
                await this.getWithdrawDay();
                console.log(result);
                this.$toast.add({
                    severity: "success",
        ...
        async cancelOrder() {
            ...
            await this.withdrawDay.CanccelOrderDay(this.item_order._id).then(async (result) => {
                await this.getWithdrawDay();
                console.log(result)
                this.$toast.add({
                    severity: "success",
