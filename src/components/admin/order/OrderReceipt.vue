<template>
  <div class="flex justify-content-center align-items-center">
    <Button @click="print()" class="border-none h-12" :label="title" :loading="loading" style="background-color: #c51605">
      ...
      <label class="ml-2">ใบออเดอร์สินค้า</label>
    </Button>
  </div>
  <!-- Print -->
  <div id="printMe" style="display: none">
    <div>
      ...
      <div style="margin: 0; padding: 0">
        <p class="print-p" style="font-weight:bold; text-align:center; margin:0; padding-bottom: 10px; padding-top:10px">
          ใบออเดอร์สินค้า</p>
        <br />
