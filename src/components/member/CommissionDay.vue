<template>
    <div class="mt-4 ">
        <h1 class="md:m-0 text-center">Commission (Day)</h1>
        <p class="mt-0 text-center"><strong>หมายเหตุ : </strong>ค่าคอมมิชชั่นจากการแนะนำ</p>
...
export default {
    ...
    methods: {
        async GetCommissionDay() {
            await this.commission_day.getCommissionDay().then(result => {
