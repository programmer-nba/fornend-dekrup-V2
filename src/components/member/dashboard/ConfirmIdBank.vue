<template>
  <div class="container">
    <div
      ...
      style="background: red; height: 60px; width: 100%"
    >
      <Button
        type="button"
        severity="danger"
        label="กลับไปยังหน้าล็อกอิน"
        icon="pi pi-power-off"
        :loading="loading"
        @click="logout()"
      /><br />
    </div>
    <h1 class="text-center mt-2" style="-webkit-text-stroke: 1px">
      ยืนยันบัตรประชาชนและบัญชีธนาคาร
    </h1>
            ...
            <div class="field">
              <span class="p-float-label">
                ...
                <FileUpload
                  mode="basic"
                  :auto="true"
                  chooseLabel="แนบรูปภาพบัญชีของท่าน"
                  uploadIcon="pi pi-paperclip"
                  @uploader="chooseImageBank"
                  :customUpload="true"
                  v-if="bank_img === null"
                />
            ...
            <div class="field">
              <span class="p-float-label">
                ...
                <FileUpload
                  mode="basic"
                  :auto="true"
                  chooseLabel="แนบรูปภาพบัตรประชาชนของท่าน"
                  uploadIcon="pi pi-paperclip"
                  @uploader="chooseImageMember"
                  :customUpload="true"
    ...
    <div
      class="text-center"
      style="color: red; font-size: 20; -webkit-text-stroke: 1px"
    >
      <div>
        ** หากท่านยืนยันบัญชีและยืนยันบัตรประชาชนแล้วกรุณากด ทำรายการถัดไป
      </div>
    </div>
  </div>
</template>
      ...
      await this.members.AddBank(formData).then(async (result) => {
        if (result) {
          ...
          Swal.fire({
            ...
            text: "รอการตรวจสอบจากส่วนกลางในวันเวลาทำการภายใน 10-15 นาที",
